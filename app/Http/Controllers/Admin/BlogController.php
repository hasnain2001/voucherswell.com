    ...
    public function destroy(Blog $blog)
    {
         ...
         public function deleteSelected(Request $request)
        {
            ...
            if ($ids) {
                ...
                return redirect()->route('admin.blog.index')->with('success', 'Selected blogs deleted successfully.');
            } else {
                return redirect()->route('admin.blog.index')->with('error', 'No stores selected for deletion.');
            }
        }
