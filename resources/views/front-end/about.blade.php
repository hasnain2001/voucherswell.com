...
@section('description','Learn more about cut2coupon, your go-to source for the best deals and discounts. Discover our mission, values, and how we help you save more.')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light shadow-sm p-3 rounded">
            <li class="breadcrumb-item">
                <a href="/" class="text-decoration-none text-primary">@lang('nav.home')</a>
            </li>
