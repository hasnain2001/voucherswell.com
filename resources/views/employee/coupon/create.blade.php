    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form name="CreateStore" id="CreateStore" method="POST" enctype="multipart/form-data" action="{{ route('employee.coupon.store') }}">
                    @csrf
                    <div class="row">
                        <!-- Left Column -->
                        <div class="col-md-6">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('employee.coupon.index') }}" class="btn btn-light px-4">
